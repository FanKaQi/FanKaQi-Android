...
import com.fkq.skill.interfaces.OnGroupClickListener;
import com.fkq.skill.model.ClickInfo;
...
public class StickyDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    @ColorInt
    int mGroupBackground = Color.GRAY;
    /**
     * 悬浮栏高度
     */
    int mGroupHeight = 100;
    /**
     * 分割线颜色，默认灰色
     */
    @ColorInt
